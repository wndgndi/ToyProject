...
<table background="/images/kubrickbg.jpg" width="760" height="40" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			...
			<table width="720" border="0" cellpadding="1" cellspacing="1">
				<tr bgcolor="#9DCFFF">
					...
					<tr>
						...
						<td><a href="/updateCategory/${blog.blogId}/${category.categoryId}">${category.categoryName }</td>
			...
			<form action="/insertCategory/${blog.blogId }" method="post">
				<table width="720" border="0" cellpadding="1" cellspacing="1">								
					...
					<tr>
						...
						<td><input type="radio" name="displayType" value="제목" checked>제목&nbsp;&nbsp; <input type="radio" name="displayType" value="제목 + 내용">제목 + 내용&nbsp;&nbsp;</td>
					</tr>
					<tr>
						<td width="150">설명 :</td>
